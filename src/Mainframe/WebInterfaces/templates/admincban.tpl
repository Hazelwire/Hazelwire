		...
		<div id="container">
			<div class="content">
				...
				{literal}<script type="text/javascript">
					...
					<div style="background: none repeat scroll 0pt 0pt rgb(170, 255, 170); left: 0pt; right: 0pt;  padding: 3px; position: relative; border:solid 1px rgb(0, 255, 0)">Contestant banned! {if $num_errors >0}(But with errors.){/if}</div>
					{/if}
					</div>
				{/if}
                                <div id="acform">
