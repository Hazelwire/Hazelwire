...
public class GUIBuilder implements Observer{
	...
	private void addGUIElements(Shell shell){
		...
		sash.setBackground(tabFolder.getDisplay().getSystemColor(SWT.COLOR_DARK_GRAY));
		...
		ScrolledComposite selectedComp = new ScrolledComposite(wrapper, SWT.V_SCROLL);
		...
		importB.setBackground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_BACKGROUND));
		...
		label.setText("Total amount of points: "+ ModsBookkeeper.getInstance().getTotalPoints()+ "\t");
		...
		if(selected != -1){
			modName.setText("Module: "+ModsBookkeeper.getInstance().getSelectedMods().get(selected).getName());
		}
		else{
		...
		ScrolledComposite tagswrap = new ScrolledComposite(wrapper2, SWT.V_SCROLL|SWT.BORDER); 
		...
		packages =  new Text(wrapper2, SWT.READ_ONLY | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
		...
		ScrolledComposite optionsWrapper = new ScrolledComposite(wrapper3, SWT.V_SCROLL | SWT.BORDER);
		...
		composite_7.setBackground(SWTResourceManager.getColor(SWT.COLOR_DARK_GREEN));
		
		composite_7.setLayout(new GridLayout(1, true)); 
		Mod selectedMod = ModsBookkeeper.getInstance().getSelectedMod();
		if(selectedMod != null){
			HashMap<String, String> options = selectedMod.getOptions();
			for(String s : options.keySet()){
				new OptionsComposite(composite_7, SWT.NONE, s, selectedMod, this);
			}
		}
		
		optionsWrapper.setContent(composite_7);
		optionsWrapper.setMinSize(composite_7.computeSize(SWT.DEFAULT, SWT.DEFAULT));
				...
				btnDefaults.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
				btnDefaults.setText("Defaults");
				btnDefaults.addMouseListener(new DefaultMouseListener(this, composite_7));
		...
		composite_1.setLayoutData(new GridData(SWT.CENTER, SWT.TOP, true, false, 1, 1));
		...
		text_2.setText("");
		GridData gd_text_2 = new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1);
		...
		Label lblOverview = new Label(composite_3, SWT.SEPARATOR | SWT.HORIZONTAL);
		...
		Label lblOverview_1 = new Label(composite_3, SWT.SEPARATOR | SWT.HORIZONTAL);
		lblOverview_1.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		GridData gd_composite_5 = new GridData(SWT.FILL, SWT.FILL, true, true, 1, 2);
		...
		GridData gd_txtHazelwireVm = new GridData(SWT.RIGHT, SWT.CENTER, true, false, 1, 1);
		...
		GridData gd_text_3 = new GridData(SWT.RIGHT, SWT.CENTER, true, false, 1, 1);
		gd_text_3.widthHint = 100;
		text_3.setLayoutData(gd_text_3);
		
		text_4 = new Text(composite_5, SWT.BORDER | SWT.READ_ONLY | SWT.WRAP | SWT.MULTI);
		...
		lblDerpsep.setLayoutData(new GridData(SWT.CENTER, SWT.FILL, false, false, 1, 2));
		lblDerpsep.setText("derpsep");
		
		ScrolledComposite scrolledComposite = new ScrolledComposite(composite_2, SWT.V_SCROLL);
		...
		scrolledComposite.setMinSize(canvas_1.computeSize(SWT.DEFAULT, SWT.DEFAULT));
		
		lblTotalAmountOf = new Label(composite_2, SWT.NONE);
		lblTotalAmountOf.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		GridData gd_btnGenerate = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
	...
	/*
	 * Deze methode update de labels die de totale score bijhouden 
	 * (op allebei de tabs)
	 */
	public void updateScoreLabels(){
		...
		if(lblTotalAmountOf != null){
			lblTotalAmountOf.setText("Total amount of points: "+ ModsBookkeeper.getInstance().getTotalPoints());
			label.redraw();
		}
	}
	...
	public void update(Observable obs, Object obj){
		...
		if(modName != null){
			if(selected != -1){
				modName.setText("Module: "+ ModsBookkeeper.getInstance().getSelectedMods().get(selected-1).getName());
			}
			else{
				modName.setText("No module selected");
			}
