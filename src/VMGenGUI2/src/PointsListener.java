...
public class PointsListener implements MouseListener, KeyListener, SelectionListener {
	...
	public void mouseUp(MouseEvent m) {
		...
		if(m.getSource() instanceof Button){
			if(selected != null){
				Challenge challenge = selected.getChallenge(challenges.getText());
			...
			if(selected != null){
				...
				if(challenge != null){
					try{
						...
						points.setText(newPoints+""); //Yes, I know dat is niet nodig
	...
	public void widgetSelected(SelectionEvent s) {
		...
		if(m != null){
			Challenge c = m.getChallenge(challenges.getText());
			if(c!=null){
