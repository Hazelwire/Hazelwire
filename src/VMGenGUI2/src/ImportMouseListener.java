...
public class ImportMouseListener implements MouseListener {
	...
	public void mouseUp(MouseEvent arg0) {
		FileDialog fd = new FileDialog(((Button)arg0.getSource()).getShell(), SWT.OPEN);
        fd.setText("Import");
       /*
        * Nu zijn alle extensies toegestaan. Maar je kunt ook een subset aangeven. Als je 
        * meer dan een extensie wil toestaan, kun je die gewoon met , "*.<extensie>" toevoegen.
        */
        String[] filterExt = { "*.*" };
